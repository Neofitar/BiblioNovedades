...
const diccionario = {
  libros: [
    {id: '15',cover: '/2023-08/img/portadas/15.png',titulo: 'Soñando el territorio: añoranzas, deseos y sueños.', autor: 'Corporación Autónoma Regional de Cundinamarca',tema: 'Arquitectura e Ingenierías',descripcion: 'Proyecto documental, que a través de las imágenes y testimonios, se realiza un proceso de intervención socioambiental que busca fortalecer la cultura ambiental de los actores sociales que habitan en las regiones de las cuencas hidrográficas del territorio CAR en los departamentos de Cundinamarca, Boyacá y la zona rural de Bogotá.',url: 'https://bibliodigital.ugc.edu.co/login?url=https://search.ebscohost.com/login.aspx?direct=true&db=cat07695a&AN=ugc.254745&lang=es&site=eds-live'},
